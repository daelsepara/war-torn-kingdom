...
<ROUTINE HARBOUR-MARLOCK ("AUX" KEY CHOICE ITEMS DESTINATION)
	<COND (,CURRENT-SHIP
		<COND (<NOT <GETP ,CURRENT-SHIP ,P?DOCKED>>
			<PUTP ,CURRENT-SHIP ,P?DOCKED ,DOCK-MARLOCK>
		)>
	)>
	<DO (I 1 3)
			...
			<COND (,CURRENT-SHIP
				<COND (<IS-DOCKED ,DOCK-MARLOCK>
					<COND (<VALIDATE-CARGO ,MARLOCK-CARGO-SELL>
						<STORY-JUMP ,STORY084>
						<PUTP ,CURRENT-SHIP ,P?DOCKED NONE>
						<RETURN>
					)>
				)(ELSE
					<CRLF>
...
<ROUTINE HARBOUR-TRADING-POST ("AUX" KEY CHOICE ITEMS DESTINATION)
	<COND (,CURRENT-SHIP
		<COND (<NOT <GETP ,CURRENT-SHIP ,P?DOCKED>>
			<PUTP ,CURRENT-SHIP ,P?DOCKED ,DOCK-TRADING>
		)>
	)>
...
<ROUTINE HARBOUR-YELLOWPORT ("AUX" KEY CHOICE ITEMS DESTINATION)
	<COND (,CURRENT-SHIP
		<COND (<NOT <GETP ,CURRENT-SHIP ,P?DOCKED>>
			<PUTP ,CURRENT-SHIP ,P?DOCKED ,DOCK-YELLOWPORT>
		)>
	)>
	<DO (I 1 3)
		<COND (<NOT <IN? <GET ,SHIPS-LIST .I> ,SHIPS>>
